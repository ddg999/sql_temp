...
-- 문제 id가 2인 회원의 전화번호를 010-2222-2222 로 수정해주세요
...
-- 문제 id가 1인 회원의 email 을 a@naver.com 으로 수정해보세요
update member set email = 'a@naver.com' where id = 1;
-- email 칼럼에 'a@naver.com' 가 먼저 들어가 있어서 업데이트 불가
-- unique키 제약이라 중복을 허용하지 않습니다.
