...
/*
	DECIMAL란 고정 소수점 수를 저장하는데 사용하는 SQL 데이터 타입입니다.
	금융 계산과 같이 정확한 소수점 연산이 필수적인 앱에서 유용하며,
    소수점 이하의 정확도가 중요할 때 주로 사용합니다.
    
    형식: decimal(5,2)
	--> 총 5자리 숫자를 저장할 수 있으며, 이 중 2자리는 소수부이다.
    --> -999.99에서 999.99 까지의 범위를 가진다.
*/
