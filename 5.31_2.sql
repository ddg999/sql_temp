...
select * from customer where id >= 5 and address in ('서울시 강남구', '서울시 서초구', '서울시 송파구', '서울시 강서구', '서울시 종로구');
select * from customer where id >= 5 and address like '서울시%';

-- 4. email이 NULL이 아니고 주문번호가 2번이 넘으며 종로구에 사시는 분을 검색해보자
SELECT *
FROM customer
